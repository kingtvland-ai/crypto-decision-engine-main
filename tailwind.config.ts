...
export default {
	...
	theme: {
		...
		extend: {
			fontFamily: {
				// Hebrew-capable throughout — see the note at the top of index.css.
			...
			colors: {
				...
				// Semantic trading colours. These describe DATA, never brand:
				// use them for P&L, never for emphasis. See index.css.
				profit: {
